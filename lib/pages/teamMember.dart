...
class _MemberListScreenState extends State<MemberListScreen> {
  ...
  final List<Map<String, String>> members = [
    ...
    {
      'instagram': 'deninormanzaky',
      'name': 'Deni Norman Zaky',
      'nim': '123220165',
      'image': 'assets/images/denskuy.png'
    },
  ];
  int currentIndex = 0;
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                gradient: LinearGradient(
                                  ...
                                  colors: [
                                    Color.fromARGB(255, 12, 82, 12), // Instagram gradient
                                    Color.fromARGB(255, 36, 162, 57),
                                    Color.fromARGB(255, 80, 250, 108),
                                  ],
                                ),
