      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildHeader(),
            const SizedBox(height: 16),
            _buildInfoRow(Icons.directions_car, "Nama", car!.nama),
            _buildInfoRow(Icons.directions_car, "Merk", car!.merk),
            _buildInfoRow(Icons.calendar_today, "Harga", car!.harga.toString()),
            _buildInfoRow(Icons.calendar_today, "Kapasitas Penumpang", car!.kapasitas_penumpang.toString()),
